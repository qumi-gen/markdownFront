...
!(function (e, t) {
    ...
    z = function (n, e) {
      ...
      var r = {
        replace: function (e, t) {
          return (
            (t = (t = t.source || t).replace(h, "$1")), (n = n.replace(e, t)), r
          );
        },
        getRegex: function () {
  ...
  function j(e, t, n) {
    ...
    return "!" !== e[0].charAt(0)
      ...
      : { type: "image", raw: n, href: r, title: i, text: C(s) };
  }
  var E = (function () {
      function e(e) {
        this.options = e || Z;
      ...
      return (
          ...
          if (t) {
            ...
            if (n.header.length === n.align.length) {
              ...
              for (r = n.cells.length, i = 0; i < r; i++)
                n.cells[i] = O(n.cells[i], n.header.length);
              return n;
            }
          }
        }),
          ...
          if (t) {
            for (
              ...
              (r = (c = n = f[b]).length),
                ...
                b !== k - 1 &&
                  ((i = this.rules.block.bullet.exec(f[b + 1])[0]),
                  (p
                    ? 1 === i.length || (!h && ")" === i[i.length - 1])
                    : 1 < i.length || (this.options.smartLists && i !== u)) &&
                    ((s = f.slice(b + 1).join("\n")),
                    (g.raw = g.raw.substring(0, g.raw.length - s.length)),
                    (b = k - 1))),
                (l = d || /\n\n(?!\s*$)/.test(n)),
                b !== k - 1 &&
                  ((d = "\n" === n.charAt(n.length - 1)), (l = l || d)),
                l && (g.loose = !0),
                (o = void 0),
                (a = /^\[[ xX]\] /.test(n)) &&
        ...
        (t.link = function (e) {
          ...
          if (t) {
            var n,
              r = U(t[2], "()");
            -1 < r &&
              ((n = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + r),
        ...
        (t.autolink = function (e, t) {
          ...
          if (n) {
            var r,
              i =
                "@" === n[2]
                  ? "mailto:" + (r = C(this.options.mangle ? t(n[1]) : n[1]))
                  : (r = C(n[1]));
            return {
              type: "link",
              raw: n[0],
        ...
        (t.inlineText = function (e, t, n) {
          ...
          if (r) {
            ...
            return { type: "text", raw: r[0], text: i };
          }
        }),
        e
      );
  ...
  (B.def = L(B.def)
    ...
    (B.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (B.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
    (B.item = L(B.item, "gm").replace(/bull/g, B.bullet).getRegex()),
    (B.list = L(B.list)
    ...
    (B.pedantic = P({}, B.normal, {
      ...
      heading: /^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,
      fences: D,
      paragraph: L(B.normal._paragraph)
        .replace("hr", B.hr)
        .replace("heading", " *#{1,6} *[^\n]")
  ...
  (F.punctuation = L(F.punctuation)
    .replace(/punctuation/g, F._punctuation)
    .getRegex()),
    (F._blockSkip = "\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>"),
    (F._overlapSkip = "__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*"),
    (F.em.start = L(F.em.start)
      .replace(/punctuation/g, F._punctuation)
      .getRegex()),
    (F.em.middle = L(F.em.middle)
      .replace(/punctuation/g, F._punctuation)
      .replace(/overlapSkip/g, F._overlapSkip)
      .getRegex()),
    (F.em.endAst = L(F.em.endAst, "g")
      .replace(/punctuation/g, F._punctuation)
      .getRegex()),
    (F.em.endUnd = L(F.em.endUnd, "g")
      .replace(/punctuation/g, F._punctuation)
      .getRegex()),
    (F.strong.start = L(F.strong.start)
      .replace(/punctuation/g, F._punctuation)
      .getRegex()),
    (F.strong.middle = L(F.strong.middle)
      .replace(/punctuation/g, F._punctuation)
      .replace(/blockSkip/g, F._blockSkip)
      .getRegex()),
    (F.strong.endAst = L(F.strong.endAst, "g")
      .replace(/punctuation/g, F._punctuation)
      .getRegex()),
    (F.strong.endUnd = L(F.strong.endUnd, "g")
      .replace(/punctuation/g, F._punctuation)
      .getRegex()),
    (F.blockSkip = L(F._blockSkip, "g").getRegex()),
    (F.overlapSkip = L(F._overlapSkip, "g").getRegex()),
    (F._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (F.link = L(F.link)
      ...
      .getRegex()),
    (F.reflink = L(F.reflink).replace("label", F._label).getRegex()),
    (F.reflinkSearch = L(F.reflinkSearch, "g")
    ...
    (F.gfm = P({}, F.normal, {
      escape: L(F.escape).replace("])", "~|])").getRegex(),
    ...
    (F.gfm.url = L(F.gfm.url, "i")
      .replace("email", F.gfm._extended_email)
      .getRegex()),
    (F.breaks = P({}, F.gfm, {
      br: L(F.br).replace("{2,}", "*").getRegex(),
      text: L(F.gfm.text)
        .replace("\\b_", "\\b_| {2,}\\n")
        .replace(/\{2,\}/g, "*")
        .getRegex(),
  ...
  var H = (function () {
      function n(e) {
        ...
        this.options.pedantic
          ? ((t.block = W.pedantic), (t.inline = X.pedantic))
          : this.options.gfm &&
            ((t.block = W.gfm),
              ...
              case "table":
                ...
                for (r = s.cells.length, t = 0; t < r; t++)
                  for (
                    ...
                    (s.tokens.cells[t][n] = []),
                      this.inlineTokens(i[n], s.tokens.cells[t][n]);
                break;
              case "blockquote":
        ...
        (i.inlineTokens = function (e, t, n, r, i) {
          ...
          if (this.tokens.links) {
            ...
            if (0 < o.length)
              for (
                ...
                o.includes(l[0].slice(l[0].lastIndexOf("[") + 1, -1)) &&
                  (a =
                    a.slice(0, l.index) +
                    "[" +
          ...
          for (; e; )
            if ((s = this.tokenizer.escape(e)))
              ...
              (e = e.substring(s.raw.length)),
                "link" === s.type &&
                  (s.tokens = this.inlineTokens(s.text, [], !0, r)),
                t.push(s);
              ...
              (e = e.substring(s.raw.length)),
                "link" === s.type &&
                  (s.tokens = this.inlineTokens(s.text, [], !0, r)),
                t.push(s);
            else if ((s = this.tokenizer.strong(e, a, i)))
              (e = e.substring(s.raw.length)),
                (s.tokens = this.inlineTokens(s.text, [], n, r)),
                t.push(s);
            else if ((s = this.tokenizer.em(e, a, i)))
              (e = e.substring(s.raw.length)),
                (s.tokens = this.inlineTokens(s.text, [], n, r)),
                t.push(s);
              ...
              (e = e.substring(s.raw.length)),
                (s.tokens = this.inlineTokens(s.text, [], n, r)),
                t.push(s);
            else if ((s = this.tokenizer.autolink(e, V)))
              (e = e.substring(s.raw.length)), t.push(s);
            else if (n || !(s = this.tokenizer.url(e, V))) {
              if ((s = this.tokenizer.inlineText(e, r, G)))
                (e = e.substring(s.raw.length)),
                  (i = s.raw.slice(-1)),
                  t.push(s);
              else if (e) {
        ...
        (t.code = function (e, t, n) {
          ...
          return (
            !this.options.highlight ||
              (null != (r = this.options.highlight(e, i)) &&
                r !== e &&
                ((n = !0), (e = r))),
            i
              ? '<pre><code class="' +
            ...
            switch ((u = e[w]).type) {
              ...
              case "heading":
                x += this.renderer.heading(
                  ...
                  u.depth,
                  re(this.parseInline(u.tokens, this.textRenderer)),
                  this.slugger
                );
                continue;
              case "code":
                ...
                continue;
              case "table":
                for (a = o = "", i = u.header.length, n = 0; n < i; n++)
                ...
                for (
                  ...
                  for (
                    a = "", s = (l = u.tokens.cells[n]).length, r = 0;
                    r < s;
                    r++
                  )
              ...
              case "list":
                for (
                  ...
                  (k = (d = u.items[n]).checked),
                    (b = d.task),
                    (f = ""),
                    d.task &&
                      ((m = this.renderer.checkbox(k)),
                      g
                    ...
                    (c += this.renderer.listitem(f, b, k));
